...
| Classes         | Methods                                                                 | Scenario                     | Outputs |
|-----------------|---------------------------------------------                            |------------------------      |---------|
| `Shopper`		  | `countPayment(Dictionary<string name, int totalCostOf> busket )`        | If dictionary is not null    | result    |
...
| Classes         | Methods                                                                 | Scenario                     | Outputs |
|-----------------|---------------------------------------------                            |------------------------      |---------|
| `Shopper`		  | `countPayment(Dictionary<string name, int costofeachprodect> busket )`                                                           
					`checkout(int quantity, int total)`						                | If dictionary is not null    | result    |
|                 |                                                                         | If dicrtionary is null       | returns 0   |
